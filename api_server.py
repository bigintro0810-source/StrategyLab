...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷1→ネックとネック→谷2の本数(上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山1→ネックとネック→山2の本数(上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷→ネックとネック→次の谷の本数(全レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山→ネックとネック→次の山の本数(全レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
