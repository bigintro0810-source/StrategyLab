...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(各区間の平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(区間ごとに個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(区間の価格差に対する倍率)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "谷2→ブレイクの最小本数", "default": 8, "type": "int"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(区間ごとに個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(区間の価格差に対する倍率)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "山2→ブレイクの最小本数", "default": 8, "type": "int"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(5区間の平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(区間ごとに個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(区間の価格差に対する倍率)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "谷3→ブレイクの最小本数", "default": 8, "type": "int"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(区間ごとに個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(区間の価格差に対する倍率)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "山3→ブレイクの最小本数", "default": 8, "type": "int"},
