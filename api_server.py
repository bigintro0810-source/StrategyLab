...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "prominence_atr_mult", "label": "谷1・谷2・ネックの値幅下限(ATR倍率、0=無効)", "default": 0.0, "type": "float", "group": "pivot_basic"},
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・ネックの突出幅上限(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_left_bars", "label": "ピボット左本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "pivot_right_bars", "label": "ピボット右本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "prominence_atr_mult", "label": "山1・山2・ネックの値幅下限(ATR倍率、0=無効)", "default": 0.0, "type": "float", "group": "pivot_basic"},
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・ネックの突出幅上限(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_left_bars", "label": "ピボット左本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "pivot_right_bars", "label": "ピボット右本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "prominence_atr_mult", "label": "谷1・谷2・谷3・ネックの値幅下限(ATR倍率、0=無効)", "default": 0.0, "type": "float", "group": "pivot_basic"},
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・谷3・ネックの突出幅上限(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "efficiency_ratio_min_context", "label": "谷1前→谷1のカウフマンER下限", "default": 0.1, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_context", "label": "谷1前→谷1の直線乖離上限", "default": 0.9, "type": "float", "group": "context_breakout_legs"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_left_bars", "label": "ピボット左本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "pivot_right_bars", "label": "ピボット右本数", "default": 5, "type": "int", "group": "pivot_basic"},
    {"name": "prominence_atr_mult", "label": "山1・山2・山3・ネックの値幅下限(ATR倍率、0=無効)", "default": 0.0, "type": "float", "group": "pivot_basic"},
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・山3・ネックの突出幅上限(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "efficiency_ratio_min_context", "label": "山1前→山1のカウフマンER下限", "default": 0.1, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_context", "label": "山1前→山1の直線乖離上限", "default": 0.9, "type": "float", "group": "context_breakout_legs"},
