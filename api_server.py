...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float", "group": "tolerance"},
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・ネックの孤立度チェック：突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "pivot_spike_window_ratio", "label": "谷1・谷2・ネックの孤立度チェック：隣接区間の本数に対する倍率", "default": 0.5, "type": "float", "group": "isolation"},
    ...
    {"name": "efficiency_ratio_min_breakout", "label": "谷2→ブレイクのカウフマンER下限", "default": 0.25, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_breakout", "label": "谷2→ブレイクの直線乖離上限", "default": 0.8, "type": "float", "group": "context_breakout_legs"},
    {"name": "efficiency_ratio_min", "label": "谷1→ネック・ネック→谷2のカウフマンER下限(平均)", "default": 0.25, "type": "float", "group": "core_legs"},
    {"name": "efficiency_ratio_floor", "label": "谷1→ネック・ネック→谷2のカウフマンER下限(個別)", "default": 0.07, "type": "float", "group": "core_legs"},
    {"name": "trendline_dev_pct", "label": "谷1→ネック・ネック→谷2の直線乖離上限", "default": 0.8, "type": "float", "group": "core_legs"},
]
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float", "group": "tolerance"},
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・ネックの孤立度チェック：突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "pivot_spike_window_ratio", "label": "山1・山2・ネックの孤立度チェック：隣接区間の本数に対する倍率", "default": 0.5, "type": "float", "group": "isolation"},
    ...
    {"name": "efficiency_ratio_min_breakout", "label": "山2→ブレイクのカウフマンER下限", "default": 0.25, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_breakout", "label": "山2→ブレイクの直線乖離上限", "default": 0.8, "type": "float", "group": "context_breakout_legs"},
    {"name": "efficiency_ratio_min", "label": "山1→ネック・ネック→山2のカウフマンER下限(平均)", "default": 0.25, "type": "float", "group": "core_legs"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "neckline_tolerance_mult", "label": "ネック1・ネック2の水準許容誤差(谷1→ネックの値幅に対する倍率、0=無効)", "default": 0.3, "type": "float", "group": "tolerance"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、両レッグ共通、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float", "group": "tolerance"},
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・谷3・ネックの孤立度チェック：突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "pivot_spike_window_ratio", "label": "谷1・谷2・谷3・ネックの孤立度チェック：隣接区間の本数に対する倍率", "default": 0.5, "type": "float", "group": "isolation"},
    {"name": "efficiency_ratio_min_context", "label": "谷1前→谷1のカウフマンER下限", "default": 0.1, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_context", "label": "谷1前→谷1の直線乖離上限", "default": 0.9, "type": "float", "group": "context_breakout_legs"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "neckline_tolerance_mult", "label": "ネック1・ネック2の水準許容誤差(山1→ネックの値幅に対する倍率、0=無効)", "default": 0.3, "type": "float", "group": "tolerance"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、両レッグ共通、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float", "group": "tolerance"},
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・山3・ネックの孤立度チェック：突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float", "group": "isolation"},
    {"name": "pivot_spike_window_ratio", "label": "山1・山2・山3・ネックの孤立度チェック：隣接区間の本数に対する倍率", "default": 0.5, "type": "float", "group": "isolation"},
    {"name": "efficiency_ratio_min_context", "label": "山1前→山1のカウフマンER下限", "default": 0.1, "type": "float", "group": "context_breakout_legs"},
    {"name": "trendline_dev_pct_context", "label": "山1前→山1の直線乖離上限", "default": 0.9, "type": "float", "group": "context_breakout_legs"},
