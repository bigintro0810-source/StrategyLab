...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(谷1→ネック・ネック→谷2の平均、谷2→ブレイクも同じ基準)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(谷1→ネック・ネック→谷2・谷2→ブレイク、個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(谷1→ネック・ネック→谷2・谷2→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の最低基準(谷1前→谷1、緩め)", "default": 0.1, "type": "float"},
    {"name": "efficiency_ratio_floor_context", "label": "カウフマン効率比の下限(谷1前→谷1、緩め、0=無効)", "default": 0.0, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の許容幅(谷1前→谷1、緩め)", "default": 2.0, "type": "float"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float"},
    {"name": "breakout_buffer_mult", "label": "ブレイク判定の余白(谷の深さに対する倍率)", "default": 0.075, "type": "float"},
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(山1→ネック・ネック→山2の平均、山2→ブレイクも同じ基準)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(山1→ネック・ネック→山2・山2→ブレイク、個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(山1→ネック・ネック→山2・山2→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の最低基準(山1前→山1、緩め)", "default": 0.1, "type": "float"},
    {"name": "efficiency_ratio_floor_context", "label": "カウフマン効率比の下限(山1前→山1、緩め、0=無効)", "default": 0.0, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の許容幅(山1前→山1、緩め)", "default": 2.0, "type": "float"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(谷1→ネック1〜ネック2→谷3の4区間平均、谷3→ブレイクも同じ基準)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(谷1→ネック1〜ネック2→谷3・谷3→ブレイク、個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(谷1→ネック1〜ネック2→谷3・谷3→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の最低基準(谷1前→谷1、緩め)", "default": 0.1, "type": "float"},
    {"name": "efficiency_ratio_floor_context", "label": "カウフマン効率比の下限(谷1前→谷1、緩め、0=無効)", "default": 0.0, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の許容幅(谷1前→谷1、緩め)", "default": 2.0, "type": "float"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の最低基準(山1→ネック1〜ネック2→山3の4区間平均、山3→ブレイクも同じ基準)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(山1→ネック1〜ネック2→山3・山3→ブレイク、個別に満たす必要あり)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の許容幅(山1→ネック1〜ネック2→山3・山3→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の最低基準(山1前→山1、緩め)", "default": 0.1, "type": "float"},
    {"name": "efficiency_ratio_floor_context", "label": "カウフマン効率比の下限(山1前→山1、緩め、0=無効)", "default": 0.0, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の許容幅(山1前→山1、緩め)", "default": 2.0, "type": "float"},
