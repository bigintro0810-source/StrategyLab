...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・ネックの孤立度チェック: 突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float"},
    {"name": "pivot_spike_window_ratio", "label": "谷1・谷2・ネックの孤立度チェック: 隣接区間の本数に対する倍率", "default": 0.5, "type": "float"},
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷1→ネック・ネック→谷2の本数(上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "ネック→谷2の本数(谷1→ネックの本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
    {"name": "top_tolerance_mult", "label": "谷1・谷2の水準許容誤差(谷1→ネックの値幅に対する倍率)", "default": 0.15, "type": "float"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float"},
    {"name": "breakout_buffer_mult", "label": "ブレイク判定の余白(谷の深さに対する倍率)", "default": 0.075, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の下限(谷1前→谷1)", "default": 0.1, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の上限(谷1前→谷1)", "default": 2.0, "type": "float"},
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の下限(谷1→ネック・ネック→谷2の平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(谷1→ネック・ネック→谷2の個別値)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の上限(谷1→ネック・ネック→谷2)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_breakout", "label": "カウフマン効率比の下限(谷2→ブレイク)", "default": 0.25, "type": "float"},
    {"name": "trendline_dev_pct_breakout", "label": "直線乖離の上限(谷2→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "谷2→ブレイクの最小本数", "default": 3, "type": "int"},
    {"name": "breakout_deadline_ratio_max", "label": "谷2→ブレイクの最大本数(谷1→ネックの本数に対する倍率)", "default": 3.33, "type": "float"},
    {"type": "range", "name_min": "interval_symmetry_ratio_min", "name_max": "interval_symmetry_ratio_max", "label": "谷1前→ネックの本数(ネック→ブレイクの本数に対する倍率)", "default_min": 0.67, "default_max": 1.5, "value_type": "float"},
    {"name": "retest_buffer_mult", "label": "リテスト判定の余白(ブレイク判定の余白に対する倍率)", "default": 1.5, "type": "float"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・ネックの孤立度チェック: 突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float"},
    {"name": "pivot_spike_window_ratio", "label": "山1・山2・ネックの孤立度チェック: 隣接区間の本数に対する倍率", "default": 0.5, "type": "float"},
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山1→ネック・ネック→山2の本数(上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "ネック→山2の本数(山1→ネックの本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
    {"name": "top_tolerance_mult", "label": "山1・山2の水準許容誤差(山1→ネックの値幅に対する倍率)", "default": 0.15, "type": "float"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float"},
    {"name": "breakout_buffer_mult", "label": "ブレイク判定の余白(谷の深さに対する倍率)", "default": 0.075, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の下限(山1前→山1)", "default": 0.1, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の上限(山1前→山1)", "default": 2.0, "type": "float"},
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の下限(山1→ネック・ネック→山2の平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(山1→ネック・ネック→山2の個別値)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の上限(山1→ネック・ネック→山2)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_breakout", "label": "カウフマン効率比の下限(山2→ブレイク)", "default": 0.25, "type": "float"},
    {"name": "trendline_dev_pct_breakout", "label": "直線乖離の上限(山2→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "山2→ブレイクの最小本数", "default": 3, "type": "int"},
    {"name": "breakout_deadline_ratio_max", "label": "山2→ブレイクの最大本数(山1→ネックの本数に対する倍率)", "default": 3.33, "type": "float"},
    {"type": "range", "name_min": "interval_symmetry_ratio_min", "name_max": "interval_symmetry_ratio_max", "label": "山1前→ネックの本数(ネック→ブレイクの本数に対する倍率)", "default_min": 0.67, "default_max": 1.5, "value_type": "float"},
    {"name": "retest_buffer_mult", "label": "リテスト判定の余白(ブレイク判定の余白に対する倍率)", "default": 1.5, "type": "float"},
    {"name": "breakout_type", "label": "ブレイク判定基準", "default": "close", "type": "string_choice", "string_choices": _SHAPE_BREAKOUT_TYPE_CHOICES},
]
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "谷1・谷2・谷3・ネックの孤立度チェック: 突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float"},
    {"name": "pivot_spike_window_ratio", "label": "谷1・谷2・谷3・ネックの孤立度チェック: 隣接区間の本数に対する倍率", "default": 0.5, "type": "float"},
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷→ネック・ネック→次の谷の本数(全レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "ネック→次の谷の本数(直前区間の本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
    {"name": "top_tolerance_mult", "label": "谷1・谷2・谷3の水準許容誤差(3点全体の最大最小差、谷1→ネックの値幅に対する倍率)", "default": 0.15, "type": "float"},
    {"name": "neckline_tolerance_mult", "label": "ネック1・ネック2の水準許容誤差(谷1→ネックの値幅に対する倍率、0=無効)", "default": 0.3, "type": "float"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、両レッグ共通、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float"},
    {"name": "breakout_buffer_mult", "label": "ブレイク判定の余白(谷2→ネック2の深さに対する倍率)", "default": 0.075, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の下限(谷1前→谷1)", "default": 0.1, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の上限(谷1前→谷1)", "default": 2.0, "type": "float"},
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の下限(谷1→ネック1〜ネック2→谷3の4区間平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(谷1→ネック1〜ネック2→谷3の個別値)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の上限(谷1→ネック1〜ネック2→谷3)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_breakout", "label": "カウフマン効率比の下限(谷3→ブレイク)", "default": 0.25, "type": "float"},
    {"name": "trendline_dev_pct_breakout", "label": "直線乖離の上限(谷3→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "谷3→ブレイクの最小本数", "default": 3, "type": "int"},
    {"name": "breakout_deadline_ratio_max", "label": "谷3→ブレイクの最大本数(谷2→ネック2の本数に対する倍率)", "default": 3.33, "type": "float"},
    {"type": "range", "name_min": "interval_symmetry_ratio_min", "name_max": "interval_symmetry_ratio_max", "label": "谷1前→ネック1の本数(ネック2→ブレイクの本数に対する倍率)", "default_min": 0.67, "default_max": 1.5, "value_type": "float"},
    {"name": "retest_buffer_mult", "label": "リテスト判定の余白(ブレイク判定の余白に対する倍率)", "default": 1.5, "type": "float"},
    {"name": "breakout_type", "label": "ブレイク判定基準", "default": "close", "type": "string_choice", "string_choices": _SHAPE_BREAKOUT_TYPE_CHOICES},
]
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"name": "pivot_spike_excess_atr_max", "label": "山1・山2・山3・ネックの孤立度チェック: 突出幅の許容(ATR倍率、0=無効)", "default": 1.3, "type": "float"},
    {"name": "pivot_spike_window_ratio", "label": "山1・山2・山3・ネックの孤立度チェック: 隣接区間の本数に対する倍率", "default": 0.5, "type": "float"},
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山→ネック・ネック→次の山の本数(全レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "ネック→次の山の本数(直前区間の本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
    {"name": "top_tolerance_mult", "label": "山1・山2・山3の水準許容誤差(3点全体の最大最小差、山1→ネックの値幅に対する倍率)", "default": 0.15, "type": "float"},
    {"name": "neckline_tolerance_mult", "label": "ネック1・ネック2の水準許容誤差(山1→ネックの値幅に対する倍率、0=無効)", "default": 0.3, "type": "float"},
    {"type": "range", "name_min": "min_valley_depth_atr_mult", "name_max": "max_valley_depth_atr_mult", "label": "谷の深さ(ATR倍率、両レッグ共通、上限0=無制限)", "default_min": 1.0, "default_max": 0.0, "value_type": "float"},
    {"name": "breakout_buffer_mult", "label": "ブレイク判定の余白(山2→ネック2の深さに対する倍率)", "default": 0.075, "type": "float"},
    {"name": "efficiency_ratio_min_context", "label": "カウフマン効率比の下限(山1前→山1)", "default": 0.1, "type": "float"},
    {"name": "trendline_dev_pct_context", "label": "直線乖離の上限(山1前→山1)", "default": 2.0, "type": "float"},
    {"name": "efficiency_ratio_min", "label": "カウフマン効率比の下限(山1→ネック1〜ネック2→山3の4区間平均)", "default": 0.25, "type": "float"},
    {"name": "efficiency_ratio_floor", "label": "カウフマン効率比の下限(山1→ネック1〜ネック2→山3の個別値)", "default": 0.07, "type": "float"},
    {"name": "trendline_dev_pct", "label": "直線乖離の上限(山1→ネック1〜ネック2→山3)", "default": 0.8, "type": "float"},
    {"name": "efficiency_ratio_min_breakout", "label": "カウフマン効率比の下限(山3→ブレイク)", "default": 0.25, "type": "float"},
    {"name": "trendline_dev_pct_breakout", "label": "直線乖離の上限(山3→ブレイク)", "default": 0.8, "type": "float"},
    {"name": "breakout_deadline_min_bars", "label": "山3→ブレイクの最小本数", "default": 3, "type": "int"},
    {"name": "breakout_deadline_ratio_max", "label": "山3→ブレイクの最大本数(山2→ネック2の本数に対する倍率)", "default": 3.33, "type": "float"},
    {"type": "range", "name_min": "interval_symmetry_ratio_min", "name_max": "interval_symmetry_ratio_max", "label": "山1前→ネック1の本数(ネック2→ブレイクの本数に対する倍率)", "default_min": 0.67, "default_max": 1.5, "value_type": "float"},
    {"name": "retest_buffer_mult", "label": "リテスト判定の余白(ブレイク判定の余白に対する倍率)", "default": 1.5, "type": "float"},
    {"name": "breakout_type", "label": "ブレイク判定基準", "default": "close", "type": "string_choice", "string_choices": _SHAPE_BREAKOUT_TYPE_CHOICES},
]
...
def _params_with_presets(name: str) -> list[dict]:
    ...
    for spec in INDICATOR_PARAM_SPECS.get(name, []):
        spec_copy = dict(spec)
        # type="range"の下限〜上限まとめ型は単一のnameを持たない(name_min/
        # name_maxの2つ)ため、presets/rangeヒントの対象外(そもそも
        # indicator_pool.py側にもこの手のペア用のヒントは存在しない)。
        spec_name = spec.get("name")
        if spec_name is not None:
            param_presets = presets.get(spec_name)
            if param_presets:
                spec_copy["presets"] = param_presets
            param_range = ranges.get(spec_name)
            if param_range:
...
def _spec_defaults(spec_list: list[dict]) -> dict[str, Any]:
    ...
    for spec in spec_list:
        if spec.get("type") == "range":
            defaults[spec["name_min"]] = spec["default_min"]
            defaults[spec["name_max"]] = spec["default_max"]
