...
_DOUBLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷1→ネックの間隔(本数、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "谷2探索窓: ネックからの本数(谷1→ネックの本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
...
_DOUBLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山1→ネックの間隔(本数、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "山2探索窓: ネックからの本数(山1→ネックの本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
...
_TRIPLE_BOTTOM_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "谷→ネックの間隔(本数、両レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "次の谷の探索窓: ネックからの本数(直前区間の本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
...
_TRIPLE_TOP_SHAPE_PARAM_SPEC: list[dict] = [
    ...
    {"type": "range", "name_min": "min_bars_between_tops", "name_max": "max_bars_between_tops", "label": "山→ネックの間隔(本数、両レッグ共通、上限0=無制限)", "default_min": 5, "default_max": 500, "value_type": "int"},
    {"type": "range", "name_min": "symmetry_ratio_min", "name_max": "symmetry_ratio_max", "label": "次の山の探索窓: ネックからの本数(直前区間の本数に対する倍率)", "default_min": 0.3, "default_max": 3.33, "value_type": "float"},
